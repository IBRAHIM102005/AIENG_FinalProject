"""Compare sequential and parallel source retrieval timings.

Default mode is offline and deterministic, so it is safe for CI and README
benchmark examples. Pass --live to call the real source fetchers.
"""
